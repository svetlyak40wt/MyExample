;; -*- Mode: Lisp; rcs-header: "$Header: /hope/lwhope1-cam/hope.0/compound/23/LISPexamples/RCS/android:toast.lisp,v 1.3.1.1 2017/01/19 11:50:00 martin Exp $" -*-
...
(uiop:define-package #:todo/toast
  (:use #:cl)
  (:export #:raise-a-toast))
(in-package todo/toast)
